...
class getVichUploader_MetadataReaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = new \Metadata\MetadataFactory(new \Metadata\Driver\DriverChain([new \Vich\UploaderBundle\Metadata\Driver\XmlDriver($a), new \Vich\UploaderBundle\Metadata\Driver\AttributeDriver(new \Vich\UploaderBundle\Metadata\Driver\AttributeReader(), [($container->services['doctrine'] ?? $container->load('getDoctrineService'))]), new \Vich\UploaderBundle\Metadata\Driver\YamlDriver($a), new \Vich\UploaderBundle\Metadata\Driver\YmlDriver($a)]), 'Metadata\\ClassHierarchyMetadata', true);
