 ...
 */
class getHistoryServiceService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Service\HistoryService' shared autowired service.
     *
     * @return \App\Service\HistoryService
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'HistoryService.php';
        ...
        if (isset($container->privates['App\\Service\\HistoryService'])) {
            return $container->privates['App\\Service\\HistoryService'];
        }

        $instance = new \App\Service\HistoryService($a, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
        ...
        return $container->privates['App\\Service\\HistoryService'] = $instance;
    }
}
