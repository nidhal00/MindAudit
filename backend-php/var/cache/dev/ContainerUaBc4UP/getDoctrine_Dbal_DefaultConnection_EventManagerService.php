...
class getDoctrine_Dbal_DefaultConnection_EventManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.documents'], [['postGenerateSchema'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['onSchemaCreateTable'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['preRemove'], 'vich_uploader.listener.remove.documents'], [['postFlush'], 'vich_uploader.listener.remove.documents'], [['prePersist'], 'vich_uploader.listener.upload.documents'], [['preUpdate'], 'vich_uploader.listener.upload.documents'], [['prePersist'], 'stof_doctrine_extensions.listener.timestampable'], [['onFlush'], 'stof_doctrine_extensions.listener.timestampable'], [['loadClassMetadata'], 'stof_doctrine_extensions.listener.timestampable']]);
