...
class getVichUploader_Listener_Clean_DocumentsService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('documents', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->load('getVichUploader_MetadataReaderService')), $a);

        if (isset($container->privates['vich_uploader.listener.clean.documents'])) {
            return $container->privates['vich_uploader.listener.clean.documents'];
        }

        return $container->privates['vich_uploader.listener.clean.documents'] = $instance;
    }
}
